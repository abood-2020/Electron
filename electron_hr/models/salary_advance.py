...
class SalaryAdvancePayment(models.Model):
    ...
    paid = fields.Boolean(string="Paid" , default=False , readonly=True)
    ...
    def onchange_employee_id(self):
        ...
        self.employee_contract_id = domain

#         return {'value': {'department': department_id}, 'value': {
...
#         }}
    ...
    def submit_to_manager(self):
        ...
        if accountant:
            ...
            #must be selected in the users table as project accountant
    ...
    def approve_request(self):
        """This Approve the employee salary advance request from accountant.
                   """
        ...
        # add condition if company 'Electron Trading 2023' will change state to approve directly
    ...
    def approve_request_acc_dept(self):
        """This Approve the employee salary advance request from ED.
                   """
        if self.activity_gm:
